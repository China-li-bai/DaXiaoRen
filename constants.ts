...
export const TRANSLATIONS = {
  en: {
    ...
    // DiagnosisBook Translations
    diagnosisTitle: "📜 Celestial Diagnosis Book",
    diagnosisSubtitle: "Based on Ni Haixia's Five Elements Theory",
    userAttribute: "Your Attributes",
    birthYear: "Birth Year",
    heavenlyStem: "Heavenly Stem",
    earthlyBranch: "Earthly Branch",
    element: "Five Elements",
    currentSituation: "Current Situation",
    conflict: "Five Elements Conflict",
    description: "Description",
    villainInfo: "Villain Information",
    villainDirection: "Villain Direction",
    villainType: "Villain Type",
    villainCharacteristics: "Characteristics",
    solution: "Solution",
    shoeType: "Required Shoe",
  ...
  zh: {
    ...
    onboardingTitle: "🔮 八卦算命 · 入门",
    onboardingSubtitle: "根据倪海厦五行理论，推算你的五行命格和小人方位",
    step1Title: "第一步：出生年份",
    step1Desc: "选择你的出生年份，推算天干地支和五行属性",
    step2Title: "第二步：床头朝向",
    step2Desc: "你睡觉时床头朝哪个方向？",
    step3Title: "第三步：大门朝向",
    step3Desc: "你家大门朝哪个方向？",
    step4Title: "第四步：当前烦恼",
    step4Desc: "最近有什么烦恼？（可选）",
    next: "下一步",
    prev: "上一步",
    submitDiagnosis: "【生成诊断书】",
    ...
    // DiagnosisBook Translations
    diagnosisTitle: "📜 天机诊断书",
    diagnosisSubtitle: "基于倪海厦五行生克理论",
    userAttribute: "你的属性",
    birthYear: "出生年份",
    heavenlyStem: "天干",
    earthlyBranch: "地支",
    ...
    description: "描述",
    villainInfo: "小人信息",
    villainDirection: "小人方位",
    villainType: "小人类型",
    villainCharacteristics: "特征",
    solution: "克制方案",
    shoeType: "专用拖鞋",
    optimalTime: "最佳时辰",
    psychologicalEffect: "心理效果",
    startRitual: "【开始镇压】",
    retryDiagnosis: "【重新诊断】",
    elements: {
      wood: "木",
